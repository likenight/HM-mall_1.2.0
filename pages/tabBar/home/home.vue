...
export default {
	data() {
		return {
			...
			// 分类菜单
			categoryList: [
				{ id: 1, name: '化妆档期', img: '/static/img/category/1.png' },
				{ id: 2, name: '礼服档期', img: '/static/img/category/2.png' },
				{ id: 3, name: '秀禾档期', img: '/static/img/category/3.png' },
				{ id: 4, name: '婚纱档期', img: '/static/img/category/4.png' },
